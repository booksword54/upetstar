package com.superb.upetstar.upsmine.controller;
...
import com.superb.upetstar.upsmine.repository.PetRepository;
...
public class PetController {
     ...
     */
    @ApiOperation("添加宠物")
    @CacheEvict(cacheNames = {"userCache", "petCache", "adoptCache"}, beforeInvocation = true, allEntries = true)
    @PostMapping("/save")
